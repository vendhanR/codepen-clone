...
const ProjectCard = ({ project, index }) => {
  return (
    <motion.div
      key={index}
      className="bg-dark p-2 d-flex justify-content-center align-items-center flex-column rounded overflow-hidden"
    ...
    >
      ...
      <div className="d-flex justify-content-start align-items-center w-100 gap-2 p-2">
        <div
          className="d-flex justify-content-center align-items-center rounded-circle overflow-hidden bg-secondary pt-3 px-3"
        ...
        >
          {project?.user?.photoURL ? (
            ...
            <>
              <p className="text-capitalize text-white d-flex justify-content-center align-items-center w-100 h-100">
        ...
        <div className="d-flex justify-content-between  w-100 align-items-center">
          <div>
          <p className="text-white p-0 m-0"alert>{project?.title}</p>
